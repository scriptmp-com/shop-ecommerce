...
function nasa_wpb_organic_farm() {
    $imgs_1 = elessi_import_upload('/wp-content/uploads/2022/06/farm-slider-bottom.png', '3657', array(
        'post_title' => 'farm-slider-bottom',
        'post_name' => 'farm-slider-bottom',
    ));
    
    $imgs_2 = elessi_import_upload('/wp-content/uploads/2022/06/farm-about-us.jpg', '3660', array(
        'post_title' => 'farm-about-us',
        'post_name' => 'farm-about-us',
    ));
    
    $imgs_3 = elessi_import_upload('/wp-content/uploads/2022/06/farm-choose-us.png', '3094', array(
        'post_title' => 'farm-choose-us',
        'post_name' => 'farm-choose-us',
    ));
    
    $imgs_4 = elessi_import_upload('/wp-content/uploads/2022/06/farm-icon1.png', '2914', array(
        'post_title' => 'farm-icon1',
        'post_name' => 'farm-icon1',
    ));
    
    $imgs_5 = elessi_import_upload('/wp-content/uploads/2022/06/farm-icon2.png', '2915', array(
        'post_title' => 'farm-icon2',
        'post_name' => 'farm-icon2',
    ));
    
    $imgs_6 = elessi_import_upload('/wp-content/uploads/2022/06/farm-icon3.png', '2916', array(
        'post_title' => 'farm-icon3',
        'post_name' => 'farm-icon3',
    ));
    
    $imgs_7 = elessi_import_upload('/wp-content/uploads/2022/06/farm-icon4.png', '2917', array(
        'post_title' => 'farm-icon4',
        'post_name' => 'farm-icon4',
    ));
    
    $imgs_url_1 = elessi_import_upload('/wp-content/uploads/2022/06/farm-sign.jpg', '3783', array(
    ...
    $imgs_url_2 = elessi_import_upload('/wp-content/uploads/2022/06/farm-testimonial-bg.jpg', '3197', array(
