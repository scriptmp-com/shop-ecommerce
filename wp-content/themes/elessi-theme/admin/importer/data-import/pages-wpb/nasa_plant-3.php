...
function nasa_wpb_plant_3() {
    $imgs_1 = elessi_import_upload('/elementor/wp-content/uploads/2022/07/plant3-banner.jpg', '3318', array(
        'post_title' => 'plant3-banner',
        'post_name' => 'plant3-banner'
    ));
    
    $imgs_2 = elessi_import_upload('/elementor/wp-content/uploads/2022/07/plant3-banner2.jpg', '3318', array(
        'post_title' => 'plant3-banner2',
        'post_name' => 'plant3-banner2'
    ));
    
    $imgs_3 = elessi_import_upload('/elementor/wp-content/uploads/2022/07/plant3-banner3.jpg', '3108', array(
        'post_title' => 'plant3-banner3',
        'post_name' => 'plant3-banner3'
    ));
    
    $imgs_4 = elessi_import_upload('/elementor/wp-content/uploads/2022/07/plant3-picture.jpg', '3094', array(
        'post_title' => 'plant3-picture',
        'post_name' => 'plant3-picture'
    ));
    
    $imgs_5 = elessi_import_upload('/elementor/wp-content/uploads/2022/07/plant3-icon1.jpg', '3149', array(
        'post_title' => 'plant3-icon1',
        'post_name' => 'plant3-icon1'
    ));
    
    $imgs_6 = elessi_import_upload('/elementor/wp-content/uploads/2022/07/plant3-icon2.jpg', '3149', array(
        'post_title' => 'plant3-icon2',
        'post_name' => 'plant3-icon2'
    ));
    
    $imgs_7 = elessi_import_upload('/elementor/wp-content/uploads/2022/07/plant3-icon3.jpg', '3149', array(
        'post_title' => 'plant3-icon3',
        'post_name' => 'plant3-icon3'
    ));
    
    $imgs_8 = elessi_import_upload('/elementor/wp-content/uploads/2022/07/plant3-icon4.jpg', '3149', array(
        'post_title' => 'plant3-icon4',
        'post_name' => 'plant3-icon4'
    ));
    
    $imgs_url_1 = elessi_import_upload('/elementor/wp-content/uploads/2022/07/plant3-deal-bg.jpg', '3100', array(
