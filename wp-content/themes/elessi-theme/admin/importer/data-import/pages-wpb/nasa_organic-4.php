...
function nasa_wpb_organic_4() {
    $imgs_1 = elessi_import_upload('/wp-content/uploads/2022/06/organic4-banner1.jpg', '3139', array(
        'post_title' => 'organic4-banner1',
        'post_name' => 'organic4-banner1',
    ));
    
    $imgs_2 = elessi_import_upload('/wp-content/uploads/2022/06/organic4-banner2.jpg', '3139', array(
        'post_title' => 'organic4-banner2',
        'post_name' => 'organic4-banner2',
    ));
    
    $imgs_3 = elessi_import_upload('/wp-content/uploads/2022/06/organic4-banner3.jpg', '3139', array(
        'post_title' => 'organic4-banner3',
        'post_name' => 'organic4-banner3',
    ));
    
    $imgs_4 = elessi_import_upload('/wp-content/uploads/2022/06/organic-curve2-bg.png', '3113', array(
        'post_title' => 'organic-curve2-bg',
        'post_name' => 'organic-curve2-bg',
    ));
    
    $imgs_5 = elessi_import_upload('/wp-content/uploads/2022/06/organic4-vegetables.png', '3105', array(
        'post_title' => 'organic4-vegetables',
        'post_name' => 'organic4-vegetables',
    ));
    
    $box_1 = elessi_import_upload('/wp-content/uploads/2022/06/organic4-icon1.png', '2915', array(
        'post_title' => 'organic4-icon1',
        'post_name' => 'organic4-icon1',
    ));
    
    $box_2 = elessi_import_upload('/wp-content/uploads/2022/06/organic4-icon2.png', '2915', array(
        'post_title' => 'organic4-icon2',
        'post_name' => 'organic4-icon2',
    ));
    
    $box_3 = elessi_import_upload('/wp-content/uploads/2022/06/organic4-icon3.png', '2915', array(
        'post_title' => 'organic4-icon3',
        'post_name' => 'organic4-icon3',
    ));
    
    $box_4 = elessi_import_upload('/wp-content/uploads/2022/06/organic4-icon4-1.png', '2915', array(
        'post_title' => 'organic4-icon4-1',
        'post_name' => 'organic4-icon4-1',
    ));
    
    $imgs_url_1 = elessi_import_upload('/wp-content/uploads/2022/06/organic4-bg.jpg', '3151', array(
