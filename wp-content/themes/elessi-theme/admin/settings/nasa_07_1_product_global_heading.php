...
if (!function_exists('elessi_product_global_heading')) {
    function elessi_product_global_heading() {
        ...
        $of_options[] = array(
            "name" => esc_html__("Categories in Loop", 'elessi-theme'),
            "id" => "loop_categories",
            "std" => "0",
            "type" => "switch"
        );
        ...
        $of_options[] = array(
            ...
            "options" => array(
                ...
                "popup" => esc_html__("Popup Your Order", 'elessi-theme'),
        ...
        /* $of_options[] = array(
            "name" => esc_html__("Mini Cart - Cross-Sells", 'elessi-theme'),
        ...
        $of_options[] = array(
            "name" => esc_html__("Load Css Mobile Menu", 'elessi-theme'),
            "id" => "css_mobile_menu",
            "std" => 'async',
            "type" => "select",
            "options" => array(
        ...
        $of_options[] = array(
            ...
            "std" => "<h4>" . esc_html__("Cross-Sells Products", 'elessi-theme') . "</h4>",
            "type" => "info"
        );
