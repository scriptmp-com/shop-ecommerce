...
if (!function_exists('elessi_header_footer_heading')) {
    function elessi_header_footer_heading() {
        ...
        $of_options[] = array(
            "name" => esc_html__("Currencies Switcher - Requires WPML | WOOCS - WooCommerce Currency Switcher | CURCY - Multi Currency for WooCommerce", 'elessi-theme'),
            "id" => "switch_currency",
            "std" => 0,
            "type" => "switch"
        );
         ...
         */
        $of_options[] = array(
            "name" => esc_html__("Footer Build-In Support (Widgets Builder)", 'elessi-theme'),
            "id" => "f_buildin",
            "std" => 1,
            "type" => "switch",
        );
        ...
        if (NASA_ELEMENTOR_ACTIVE && NASA_HF_BUILDER) {
            ...
            $modes["build-in"] = esc_html__("Build-in", 'elessi-theme');
        }
