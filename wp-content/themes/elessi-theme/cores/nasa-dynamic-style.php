...
if (!function_exists('elessi_get_style_primary_color')) :
    ...
    function elessi_get_style_primary_color($color_primary = '', $return = true) {
        ...
        ?><style>
            ...
            body .product-gallery .product-video-popup,
            ...
            body .nasa-static-sidebar .btn-mini-cart a.checkout,
            ...
            body .nasa-static-sidebar .btn-mini-cart a.checkout:hover
            {
...
if (!function_exists('elessi_page_override_style')) :
    function elessi_page_override_style() {
        ...
        if ($is_page && $object_id) {
            ...
            $page_css .= elessi_get_style_main_menu_color($bg_color, $text_color);
            ...
            $page_css .= elessi_get_style_vertical_menu_color($bg_color, $text_color);
