...
if (!function_exists('elessi_search')) :
    function elessi_search($search_type = 'icon', $return = true) {
        ...
        $tmpl = $search_type == 'icon' && isset($nasa_opt['tmpl_html']) && $nasa_opt['tmpl_html'] && !function_exists('aws_get_search_form') ? true : false;
...
if (!function_exists('elessi_search_mobile')) :
    function elessi_search_mobile($return = false) {
        ...
        $tmpl = isset($nasa_opt['tmpl_html']) && $nasa_opt['tmpl_html'] && !function_exists('aws_get_search_form') ? true : false;
    ...
    function elessi_multi_languages() {
        ...
        if (isset($nasa_opt['switch_lang']) && $nasa_opt['switch_lang']) {
             ...
             */
                ...
                // $mainLang .= '<img src="' . esc_url(ELESSI_THEME_URI . '/assets/images/en.png') . '" alt="English" width="18" height="12" />';
                $mainLang .= 'English';
                $mainLang .= '</a>';
                ...
                // $selectLang .= '<img src="' . esc_url(ELESSI_THEME_URI . '/assets/images/de.png') . '" alt="Deutsch" width="18" height="12" />';
                ...
                // $selectLang .= '<img src="' . esc_url(ELESSI_THEME_URI . '/assets/images/fr.png') . '" alt="Français" width="18" height="12" />';
        ...
        if (isset($nasa_opt['switch_currency']) && $nasa_opt['switch_currency']) {
             ...
             */
            elseif (class_exists('WOOCS') || class_exists('WOOMULTI_CURRENCY_F')) {
                $currency_output = '<div class="nasa-currency-switcher nasa-transition hidden-tag"></div>';
                
                $outputHtml .= '<li class="nasa-select-currencies left rtl-right desktop-margin-right-30 rtl-desktop-margin-right-0 rtl-desktop-margin-left-30 hidden-tag">' . $currency_output . '</li>';
            }
...
if (!function_exists('elessi_back_history')) :
    function elessi_back_history() {
        ...
        if (NASA_WOO_ACTIVED) {
            if (is_product()) {
                $back_url = esc_url(wc_get_page_permalink('shop'));
            }
        ...
        return '<a class="ns-back-history margin-right-10 rtl-margin-right-0 rtl-margin-left-10" href="' . $back_url . '" title="' . esc_attr__('Back', 'elessi-theme') . '" rel="nofollow"><i class="nasa-icon pe-7s-back"></i></a>';
    }
endif;
