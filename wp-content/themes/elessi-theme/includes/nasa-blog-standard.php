...
<div class="blog-item nasa-item-standard">
    <article id="post-<?php echo (int) $postId; ?>" <?php post_class(); ?>>
        <?php if (has_post_thumbnail()) : ?>
            <a href="<?php echo esc_url($link); ?>" title="<?php echo esc_attr($title); ?>" class="entry-image nasa-blog-img blog-image-attachment nasa-block">
            ...
            <?php if ($show_author_info || $show_date_info || $show_comment) : ?>
                <div class="text-left info-wrap nasa-archive-info">
                    ...
                    <?php if ($show_date_info) : ?>
                        <a href="<?php echo esc_url($link_date); ?>" title="<?php esc_attr($date_post); ?>">
