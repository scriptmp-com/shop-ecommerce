        ...
        return {
            isMsie: function() {
                if (typeof navigator.userAgentData !== 'undefined') {
                    ...
                    return navigator.userAgent && /(msie|trident)/i.test(navigator.userAgent) ? navigator.userAgent.match(/(msie |rv:)(\d+(.\d+)?)/i)[2] : false;
                }
            },
...
jQuery(document).ready(function($) {
    ...
    if (typeof search_options !== 'undefined' && typeof search_options.url !== 'undefined') {
        $('body').on('focus keyup', '.live-search-input', function() {
            var _this = $(this);
