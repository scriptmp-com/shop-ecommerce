    ...
    function elessi_product_page_heading() {
        ...
        $of_options[] = array(
            ...
            "options" => array(
                ...
                "left-bar" => esc_html__("Side", 'elessi-theme')
            ),
            'class' => 'nasa-category_sidebar nasa-category_sidebar-top nasa-theme-option-child'
        );
        
        $of_options[] = array(
            "name" => esc_html__("Type View", 'elessi-theme'),
            "id" => "products_type_view",
            "std" => "grid",
            "type" => "select",
            "options" => array(
                "grid" => esc_html__("Grid View Mode", 'elessi-theme'),
                "list" => esc_html__("List View Mode", 'elessi-theme')
            )
        );
        
        $of_options[] = array(
            "name" => esc_html__("Change View Mode (Only Desktop Mode)", 'elessi-theme'),
        ...
        $of_options[] = array(
            ...
            "type" => "select",
            "options" => array(
                "grid-row" => esc_html__("Grid Rows", 'elessi-theme'),
        ...
        $of_options[] = array(
            "name" => esc_html__("After Breadcrumb - Only for Shop Page", 'elessi-theme'),
            "id" => "shop_brdc_blk",
            "desc" => esc_html__("Please Create Static Block and Selected here to use.", 'elessi-theme'),
            "type" => "select",
            "options" => $arr_blocks
