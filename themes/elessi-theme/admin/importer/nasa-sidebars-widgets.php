...
function elessi_sidebars_widgets_import() {
    ...
    if (NASA_ELEMENTOR_ACTIVE) {
        ...
        $results['widgets']['widget_text'] = array(
            ...
            3 => array(
                'title' => '',
                'text' => '<p class="margin-bottom-0">© ' . date('Y') . ' <strong>Nasatheme</strong> - All Right reserved!</p>',
                'filter' => true,
                'visual' => true,
            ),
            4 => array(
