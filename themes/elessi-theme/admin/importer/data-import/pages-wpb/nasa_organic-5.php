...
function nasa_wpb_organic_5() {
    $imgs_1 = elessi_import_upload('/wp-content/uploads/2022/06/organic5-banner1.jpg', '3139', array(
        'post_title' => 'organic5-banner1',
        'post_name' => 'organic5-banner1',
    ));
    
    $imgs_2 = elessi_import_upload('/wp-content/uploads/2022/06/organic5-banner2.jpg', '3139', array(
        'post_title' => 'organic5-banner2',
        'post_name' => 'organic5-banner2',
    ));
    
    $imgs_3 = elessi_import_upload('/wp-content/uploads/2022/06/organic5-banner3.jpg', '3139', array(
        'post_title' => 'organic5-banner3',
        'post_name' => 'organic5-banner3',
    ));
    
    $imgs_url_1 = elessi_import_upload('/wp-content/uploads/2022/06/organic5-newsletter-bg.jpg', '3100', array(
